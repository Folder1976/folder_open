	...
	<tr>
		...
		<td class="left">
			<input type="text"
				   ...
				   value="<?php echo (isset($operation_header['operation_id']) AND $operation_header['user_id']) ? $users[$operation_header['user_id']]['firstname'].' '.$users[$operation_header['user_id']]['lastname'] : ''; ?>"
				   disabled
				   >
		</td>
		<td style="width: 30px;">&nbsp;</td>
...
<table class="text" style="margin-top: 15px;">
	<?php include "operation/product_list_header.php"; ?>
