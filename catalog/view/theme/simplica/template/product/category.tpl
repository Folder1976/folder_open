        ...
        <div class="l-primary_content">
                                ...
                                <?php if ( ((isset($selected_categories)) OR
                                            (isset($selected_attributes_alias) && strlen($selected_attributes_alias) > 0) OR
                                                (isset($selected_sizes) AND count($selected_sizes))) AND 
                                                    ($clear_url != '') AND
                                                        (!isset($manufacturer_main_category) OR (isset($manufacturer_main_category) AND count($manufacturers) > 1))
                                                    ) { ?>
            ...
            <div class="l-search_result-left">
                ...
                <div class="b-refinement_dropdown">
                    ...
                    <div class="b-refinement_dropdown-flyout js-min_refinement_selector">
                        <div class="b-refinement_containter">
...
?>
            ...
            <div class="l-search_result-content js-search_result-content m-search_layout-демонстрация m-six-columns">
