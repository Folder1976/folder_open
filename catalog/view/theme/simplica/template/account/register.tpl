      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          ...
          <div class="form-group f-field">
            <label class="control-label f-label" for="input-fax">
          ...
          <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field f-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="control-label f-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>">
              <span class="f-label-value"><?php echo $custom_field['name']; ?></span>
            </label>
            <div class="f-field-wrapper">
              <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control f-select">
              ...
              <span class="f-error_message">
                <span class="f-error_message-block"><?php echo $error_custom_field[$custom_field['custom_field_id']]; ?></span>
              </span>
              <?php } ?>
            </div>
          </div>
        ...
        <fieldset id="address">
          <legend><h2><?php echo $text_your_address; ?></h2></legend>
          <div class="form-group f-field">
          ...
          <div class="form-group required f-field f-state-required">
            <label class="control-label f-label" for="input-address-1">
              <span class="f-lael-value"><?php echo $entry_address_1; ?></span>
            </label>
            <div class="f-field-wrapper">
          ...
          <div class="form-group f-field">
            <label class="control-label f-label" for="input-address-2">
              <span class="f-label-value"><?php echo $entry_address_2; ?></span>
            </label>
            <div class="f-field-wrapper">
        ...
        <fieldset>
          <legend><h2><?php echo $text_your_password; ?></h2></legend>
          <div class="form-group required f-field f-state-required">
            <label class="control-label f-label" for="input-password">
              <span class="f-label-value"><?php echo $entry_password; ?></span>
            </label>
            <div class="f-field-wrapper">
              <input type="password" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control f-password" />
              <?php if ($error_password) { ?>
              <span class="f-error_message">
                <span class="f-error_message-block"><?php echo $error_password; ?></span>
              </span>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required f-field f-state-required">
            ...
            <div class="f-field-wrapper">
              <input type="password" name="confirm" value="<?php echo $confirm; ?>" placeholder="<?php echo $entry_confirm; ?>" id="input-confirm" class="form-control f-password" />
              <?php if ($error_confirm) { ?>
              <span class="f-error_message">
                <span class="f-error_message-block"><?php echo $error_confirm; ?></span>
              </span>
              <?php } ?>
            </div>
          </div>
        ...
        <fieldset>
          <legend><h2><?php echo $text_newsletter; ?></h2></legend>
          <div class="form-group f-field">
            <label class="control-label f-label">
