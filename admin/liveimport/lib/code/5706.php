...
<script type="text/javascript">
    ...
    function GetSelector(url,selector,single) {
        ...
        url = "index.php?op=css&url="+encodeURIComponent(url)+'&single='+single+'&cd='+Date.now()+'&domain=<?php  echo @$a6["\x68\x6f\163\x74"]; ?>
';
        iSelector = selector;
...
<script type="text/javascript">
    ...
    function UpdateLog()
    {
        $.get('index.php?op=feed',false, function(data) {
            ...
            logfeed.append(data);
            <?php  if (!(@$_GET["\162\157\x75\164\145"] !== "\x77\151\x7a\141\x72\144\x32\170")) { goto A4a9; } ?>
            $(".log").show();
            <?php  A4a9: ?>
