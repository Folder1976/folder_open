...
<div id="content">
                      <?php if (!empty($_GET['product_id'])) {
                        ...
                        $q = $db->query("SHOW TABLES LIKE '".DB_PREFIX."li_entities'")->row;
                        if ($q) {
                            $q = $db->query("SELECT * FROM ".DB_PREFIX."li_entities WHERE platform_id=".$product_id)->row;
                            if ($q) {
                                $qq = $db->query("SELECT * FROM ".DB_PREFIX."li_ins WHERE ins_id=".$q['ins_id'])->row;
                                $ourl = $q['ourl'];
                                if (substr($ourl,0,4)=='file')
                                    $ourl = str_replace('file', '<strong>', str_replace('row','</strong> row', $ourl));
                            }
                        }
                        ...
                        $m .= '<div class="li_panel" style="z-index:20000; overflow: hidden; position: fixed; padding:5px; border: 2px solid #AAA; background-color: #656565; left:0; bottom:0; width: 100%; height: 44px; color: white; font-family: sans-serif; font-size:14px">';
                        $m .= '<div style="display: inline-block;position: absolute;white-space:no-wrap;overflow:hidden;float:right;">';
                        $m .= '<a class="li_logo" style="font-size:14px; font-weight: bold; color: white; text-decoration: none" target="_blank" href="'.HTTP_SERVER.'liveimport">';
                        if ($q)
                            $m .= '<div class="li_id"><span style="color: grey; font-weight: bold">LiveImport product <span style="color:#3359a6">$id</span>:</span> '.$q['url'].'</div>';
                        $m .= '<img src="liveimport/lib/static/icon.png" style="vertical-align:middle;"> <font color="#8de43c">Live</font>Import</a>';

                        if ($q) {
                         if ($qq) $m .= '&nbsp;&nbsp; <font color="#AAA">Task:</font> <a style="font-size:14px; color: #7db4fb" target="_blank" href="'. HTTP_SERVER .'liveimport/index.php?route=ins&id='.$qq['ins_id'].'&donor_id='.$qq['donor_id'] .'">'. $qq['title'] . '</a>';
                         $m .= '&nbsp;&nbsp;<font color="#AAA">Product source:</font> ';
                         if (strpos($ourl, "//")) $m .= '<a style="font-size:14px; color: #7db4fb" rel="nofollow noreferrer" target="_blank" href="' . $ourl .'">' . $ourl . '</a>';
                         else $m .= '<span style="color: #7db4fb" >' . $ourl . '</span>';
                        } else
                        $m .= '&nbsp;&nbsp; <font color="#AAA"> This product was not created by LiveImport</font>';

                        $m .= "</div><div style='padding-left:10px; background-color: #656565; float:right; display: inline-block; position: relative; padding-right: 15px;'>";
                        $m .= '<a class="li_button" onclick=" $(\'#form-product\').attr(\'action\',$(\'#form-product\').attr(\'action\')+\'&li_show=1\'); $(\'#form-product\').submit(); ">Save & Show</a>';
                        if ($q and strpos($ourl, "//")) $m .= '<a class="li_button" style="background: #ffc7c7; color: #b20000 !important" href="'.HTTP_SERVER.'admin/liveimport/index.php?route=wizard1&id='.$q['donor_id'].'&add2='.$product_id.'">Add to Scheme Wizard</a>';
                        $m .= '<a class="li_button" style="background: #222; color: #CCC !important" href="'.HTTP_SERVER.'liveimport/index.php?op=ajax&command=delete_product&id='.$product_id.'">Delete Product</a>';
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-option" data-toggle="tab"><?php //echo $tab_option; ?>Размеры</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"><?php echo $entry_description_detail; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][description_detail]" placeholder="<?php echo $entry_description_detail; ?>" id="input-description_detail<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description_detail'] : ''; ?></textarea>
                    </div>
                  </div>
            ...
            <div class="tab-pane" id="tab-data">
             ...
             <div class="form-group" style="background-color: #FFB2BB;">
                <label class="col-sm-2 control-label" for="input-original_url"><span data-toggle="tooltip" title=""><?php echo $entry_original_url; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="original_url" value="<?php echo $original_url; ?>" placeholder="<?php echo $entry_original_url; ?>" id="input-original_url" class="form-control" />
                </div>
              </div>
             
             <div class="form-group">
                <label class="col-sm-2 control-label" for="input-original_code"><span data-toggle="tooltip" title=""><?php echo $entry_original_code; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="original_code" value="<?php echo $original_code; ?>" placeholder="<?php echo $entry_original_code; ?>" id="input-original_codel" class="form-control" />
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-quantity"><?php echo $entry_quantity; ?> (Забивается в закладке РАЗМЕРЫ)</label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-subtract"><?php echo $entry_subtract; ?> (Забивается в закладке РАЗМЕРЫ)</label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-stock-status"><span data-toggle="tooltip" title="<?php echo $help_stock_status; ?>"><?php echo $entry_stock_status; ?> (Забивается в закладке РАЗМЕРЫ)</span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="metka" style="margin-left: 50px;">>></span><a href="javascript:;" class="select_category" data-target="category" style="margin: 20px; font-size: 18px;">[дерево]</a><span class="metka"><<</span>
                  <input type="text" name="category" value="" placeholder="<?php echo $entry_category; ?>" id="input-category" class="form-control" />
                  <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_categories as $product_category) { ?>
                    <div id="product-category<?php echo $product_category['category_id']; ?>">
                      <input type="radio" name="main_relationships" value="<?php echo $product_category['category_id']; ?>"<?php if ($main_relationships != null && $main_relationships == $product_category['category_id']): ?> checked="checked"<?php endif; ?>>
                        ...
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              ...
                              <td class="text-left"><?php echo $entry_alternative_size; ?></td>
                              <td class="text-right"><?php echo $entry_quantity; ?></td>
                              <td class="text-left"><?php echo $entry_subtract; ?></td>
                           
                              <td class="text-left">Верхняя одежда</td>
                              <td class="text-left">Штаны</td>
                              <td class="text-left">Обувь</td>
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left" style="width: 100px;">
                                <select style="width: 100px;" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control">
                              ...
                              <td class="text-right" style="width: 100px;">
                                <input style="width: 100px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][quantity]" value="<?php echo $product_option_value['quantity']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" />
                              </td>
                              <td class="text-left" style="width: 100px;">
                                <select style="width: 100px;" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][subtract]" class="form-control">
                              ...
                              <td class="text-left">
                                <?php echo $entry_shirina_plech; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][shirina_plech]"
                                    value="<?php if(isset($product_option_value['params']['shirina_plech'])) echo $product_option_value['params']['shirina_plech']; ?>" placeholder="0" class="form-control" />
                                <br>
                                
                                <?php echo $entry_shirina_grudi; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][shirina_grudi]"
                                    value="<?php if(isset($product_option_value['params']['shirina_grudi'])) echo $product_option_value['params']['shirina_grudi']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_dlina_verh; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][dlina_verh]"
                                    value="<?php if(isset($product_option_value['params']['dlina_verh'])) echo $product_option_value['params']['dlina_verh']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_dlina_rukava; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][dlina_rukava]"
                                    value="<?php if(isset($product_option_value['params']['dlina_rukava'])) echo $product_option_value['params']['dlina_rukava']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_vorotnik; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][vorotnik]"
                                    value="<?php if(isset($product_option_value['params']['vorotnik'])) echo $product_option_value['params']['vorotnik']; ?>" placeholder="0" class="form-control" /> 
                                
                              </td>
                              
                              <td class="text-left">
                                <?php echo $entry_shirina_talii; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][shirina_talii]"
                                    value="<?php if(isset($product_option_value['params']['shirina_talii'])) echo $product_option_value['params']['shirina_talii']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_shirina_beder; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][shirina_beder]"
                                    value="<?php if(isset($product_option_value['params']['shirina_beder'])) echo $product_option_value['params']['shirina_beder']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_dlina_niz; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][dlina_niz]"
                                    value="<?php if(isset($product_option_value['params']['dlina_niz'])) echo $product_option_value['params']['dlina_niz']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_podiem; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][podiem]"
                                    value="<?php if(isset($product_option_value['params']['podiem'])) echo $product_option_value['params']['podiem']; ?>" placeholder="0" class="form-control" /> 
                                
                                
                              </td>
                              
                                <td class="text-left">
                                <?php echo $entry_s_dlina; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][s_dlina]"
                                    value="<?php if(isset($product_option_value['params']['s_dlina'])) echo $product_option_value['params']['s_dlina']; ?>" placeholder="0" class="form-control" /> 
                                <br>
                                
                                <?php echo $entry_s_shirina; ?>
                                <input style="width: 120px;" type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][params][s_shirina]"
                                    value="<?php if(isset($product_option_value['params']['s_shirina'])) echo $product_option_value['params']['s_shirina']; ?>" placeholder="0" class="form-control" /> 
...
$('#input-description_detail<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
//--></script>
  <script type="text/javascript"><!--
// Manufacturer
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-category').append(
                '<div id="product-category' + item['value'] + '"><input type="radio" name="main_relationships" value="'
                  + item['value'] + '"><i class="fa fa-minus-circle"></i> '
                  + item['label'] + '<input type="hidden" name="product_category[]" value="'
                  + item['value'] + '" /></div>'
        );
      $("#product-category" + item['value'] + " input[type=radio]:first").attr("checked", "checked");
	}
});
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '  	 <thead>';
			html += '      <tr>';
            html += '        <td class="text-left"><?php echo $entry_size; ?></td>';
			html += '        <td class="text-left"><?php echo $entry_alternative_size; ?></td>';
			html += '        <td class="text-right"><?php echo $entry_quantity; ?></td>';
			html += '        <td class="text-left"><?php echo $entry_subtract; ?></td>';
			html += '        <td class="text-right">Верхняя одежда</td>';
			html += '        <td class="text-right">Штаны</td>';
			html += '        <td class="text-right">Обувь</td>';
			html += '        <td></td>';
			html += '      </tr>';
			html += '  	 </thead>';
			html += '  	 <tbody>';
...
function addOptionValue(option_row) {
    ...
    html = '';
    html += '<tr id="option-value-row' + option_value_row + '">';
    html += '   <td class="text-left" style="width: 100px;">';
    html += '     <select style="width: 100px;" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id]" class="form-control">';
    html += $('#option-values' + option_row).html();
    html += '     </select>';
    ...
    html += '   </td>';
    html += '   <td class="text-left" style="width: 100px;">';
    html += '     <select style="width: 100px;" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][alternative_size]" class="form-control">';
    html += $('#option-values' + option_row).html();
    html += '     </select>';
    html += '   </td>';
    html += '   <td class="text-right" style="width: 100px;">';
    html += '     <input style="width: 100px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][quantity]" value="0" placeholder="Количество" class="form-control">';
    html += '   </td>';
    html += '   <td class="text-left" style="width: 100px;">';
    html += '     <select style="width: 100px;" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][subtract]" class="form-control">';
    html += '       <option value="1" selected="selected"><?php echo $text_yes; ?></option>';
    html += '       <option value="0"><?php echo $text_no; ?></option>';
    html += '     </select>';
    html += '   </td>';
    html += '   <td class="text-left">';
    html += 'Ширина плеч<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][shirina_plech]" value="" placeholder="0" class="form-control"><br>';
    html += 'Ширина груди<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][shirina_grudi]" value="" placeholder="0" class="form-control"><br>';
    html += 'Длина изделия<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][dlina_verh]" value="" placeholder="0" class="form-control"> <br>';
    html += 'Длина рукава<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][dlina_rukava]" value="" placeholder="0" class="form-control"> <br>';
    html += 'Воротник<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][vorotnik]" value="" placeholder="0" class="form-control">';
    html += '   </td>';
    html += '   <td class="text-left">';
    html += 'Ширина Талии<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][shirina_talii]" value="" placeholder="0" class="form-control"><br>';
    html += 'Ширина бедер<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][shirina_beder]" value="" placeholder="0" class="form-control"><br>';
    html += 'Длина изделия<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][dlina_niz]" value="" placeholder="0" class="form-control"><br>';
    html += 'Подъем<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][podiem]" value="" placeholder="0" class="form-control">';
    html += '   </td>';
    html += '   <td class="text-left">';
    html += 'Длина<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][s_dlina]" value="" placeholder="0" class="form-control"><br>';
    html += 'Ширина<input style="width: 120px;" type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][params][s_shirina]" value="" placeholder="0" class="form-control">';
    html += '   </td>';
    html += '   <td class="text-left">';
    html += '     <button type="button" onclick="$(this).tooltip(\'destroy\');$(\'#option-value-row0\').remove();" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="<?php echo $button_remove; ?>"><i class="fa fa-minus-circle"></i></button>';
    html += '   </td>';
    html += '</tr>';
         ...
         console.log($('#select_cetegory_target').val()+' '+id);   
            ...
            jQuery.ajax({
				...
				success: function(msg){
                    ...
                    $('#product-category').append(
                            '<div id="product-category' + id + '"><input type="radio" name="main_relationships" value="'
                              + id + '"><i class="fa fa-minus-circle"></i> '
                              + msg.category_name + '<input type="hidden" name="product_category[]" value="'
                              + id + '" /></div>'
                    );
                    $("#product-category" + item['value'] + " input[type=radio]:first").attr("checked", "checked");
